# Inside Journaling App - Universal Client

React Native and Web universal application built with Expo for iOS, Android, and Web.
...
- **Backend:** [Journal.Server/](Journal.Server/) - ASP.NET Core API
- **Models:** [Journal.Models/](Journal.Models/) - Shared data models
- **Services:** [Journal.Services/](Journal.Services/) - Business logic and AI services
